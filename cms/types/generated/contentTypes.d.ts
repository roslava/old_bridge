...
export interface ApiFactFact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documented: Schema.Attribute.Boolean & Schema.Attribute.Required;
    full_text: Schema.Attribute.Blocks;
    ...
    publishedAt: Schema.Attribute.DateTime;
    small_detail: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
...
export interface ApiHomeScreenHomeScreen extends Struct.CollectionTypeSchema {
  collectionName: 'home_screens';
  info: {
    description: '';
    displayName: 'home_screen';
...
export interface ApiPhotoLensSliderPhotoLensSlider
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::photo-lens-slider.photo-lens-slider'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiYearYear extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facts: Schema.Attribute.Relation<'oneToMany', 'api::fact.fact'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::photo-lens-slider.photo-lens-slider': ApiPhotoLensSliderPhotoLensSlider;
