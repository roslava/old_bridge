...
// console.log(photoLensSlides[0].caption, '!!')
        ...
        <>
            <div className="absolute z-[1] inset-0 flex flex-col items-center py-[80px]">
                <div className="relative max-w-[1536px] w-full min-h-full p-[23px] flex flex-col flex-1">
                    <h1 className="md:text-h1 text-6xl font-family_heading uppercase">{homeScreens[1].title}</h1>
            ...
            <BackgroundImg src={homeScreens[1].media[0].url} alt="Идея создания железной дороги"/>
        </>
    );
}